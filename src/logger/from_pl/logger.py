# from https://github.com/PyTorchLightning/pytorch-lightning/blob/dc4c3171fc0618fb463a846ccbde2e558902303b/pytorch_lightning/utilities/logger.py
...
def _sanitize_params(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for k in params.keys():
        ...
        elif type(params[k]) not in [bool, int, float, str]:
            params[k] = str(params[k])
    return params


def _add_prefix(
    metrics: Dict[str, float], prefix: str, separator: str
) -> Dict[str, float]:
